...
public class StreamingClientExample {
   ...
   private static final String USER_NAME = System.getenv("SALESFORCE_USER");
   private static final String PASSWORD = System.getenv("SALESFORCE_PASS");
   ...
   private static final String CHANNEL = VERSION_22 ? "/AccountUpdates" : "/topic/AccountUpdates";
