...
describe('removeMethodTriggers', () => {
  ...
  it('should remove triggers if no methods are provided', () => {
    ...
    expect(removeMethodTriggers(methods, connectionData)).toEqual([
      { name: 'connector1' },
      { name: 'connector2' },
    ]);
  });
...
describe('transformClassConnections', () => {
  it('should transform the connections object', () => {
    const connections: IClassConnections = {
      'class name': [
        { name: 'connector1', id: 0 },
        { name: 'connector2', id: 1 },
      ],
      'class name 2': [{ name: 'connector3', id: 2 }],
    };
    const expected = {
      classname: [{ name: 'connector1', id:0 }, { name: 'connector2', id:1 }],
      classname2: [{ name: 'connector3', id:2 }],
    };
