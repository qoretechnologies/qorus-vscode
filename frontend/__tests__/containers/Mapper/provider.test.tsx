...
describe('filterChildren', () => {
  ...
  it('should filter by isPipeline flag', () => {
    const filtered = filterChildren(children, false, 'any', false, false);
  ...
  it('should filter by recordType flag', () => {
    const filtered = filterChildren(children, false, true, false, false);
  ...
  it('should not filter if no flags are provided', () => {
    const filtered = filterChildren(children, false, false, false, false);
