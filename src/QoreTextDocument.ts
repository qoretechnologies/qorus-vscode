...
export const qoreLoc2Range = (loc: any, offset_string: string = ''): Range =>
    new Range(
...
export const pythonNameRange = (
    ...
    let line_part = line.substr(object_range.start.character);
