...
const SchemaModulesIconName = 'database.svg';
const ScriptsIconName = 'shapes.svg';
const TestsIconName = 'lab-test.svg';
...
export class QorusIcons {
  ...
  update(extensionPath: string) {
    ...
    this.schemaModulesIcon = {
      dark: Uri.file(join(extensionPath, DarkIconsDirRelPath, SchemaModulesIconName)),
      light: Uri.file(join(extensionPath, LightIconsDirRelPath, SchemaModulesIconName)),
    };
    this.scriptsIcon = {
      dark: Uri.file(join(extensionPath, DarkIconsDirRelPath, ScriptsIconName)),
      light: Uri.file(join(extensionPath, LightIconsDirRelPath, ScriptsIconName)),
    };
    this.testIcon = {
      dark: Uri.file(join(extensionPath, DarkIconsDirRelPath, TestsIconName)),
      light: Uri.file(join(extensionPath, LightIconsDirRelPath, TestsIconName)),
    };
  }
  ...
  getSchemamodulesIcon() {
    return this.schemaModulesIcon;
  }
