...
- Drafts can now be properly deleted inside the WebView using the delete button

#### New features

- Relevant inputs now have either auto-focus or are focused when the user starts typing automatically (such inputs are indicated by a keyboard icon on the right side of the input)
